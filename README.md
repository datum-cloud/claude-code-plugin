...
- A two-reviewer loop (`/pr-review`) that runs an adversarial and a conventions review on every PR a session opens, then fixes, pushes, and sets auto-merge when the two agree
